...
const DEFAULT_MAPPING_RESOURCES = require('./default-mapping-resources.json');
...
module.exports = class ShakrAPI {
    ...
    async createEditToken(template_style_version_id) {
        ...
        const res = await this._request({
            ...
            body: {
                ...
                mapping: {
                    ...
                    resources: DEFAULT_MAPPING_RESOURCES
                },
                edit_token: true
            }
        });
