...
module.exports = class ShakrAPI {
    ...
    async createRenderSession(template_style_version_id, resources) {
        await this.authorize();
    ...
    async generateAspectRatioVariation(base_render_session_id, aspect_ratio_variation_id) {
        ...
        const aspect_ratio_variation_render = await this.createRenderSession(aspect_ratio_variation_id, mapping.resources);
